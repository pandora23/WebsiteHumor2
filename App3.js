...
var continueRunning = function(){
	...
	$(".Freq1").text("Most frequent words and bigrams that co-occur with \'"+ AmbiguousWord +"\' given \'" + p1 + "\':");
	$(".Freq2").text("Most frequent words and bigrams that co-occur with \'"+ AmbiguousWord +"\' given \'" + p2 + "\':");
	$(".Freq3").text("Most frequent words and bigrams that co-occur with \'"+ AmbiguousWord +"\' given \'" + m1 + "\':");
	$(".Freq4").text("Most frequent words and bigrams that co-occur with \'"+ AmbiguousWord +"\' given \'" + m2 + "\':");
...
function getFrequencies(){
	...
	var contextOnly = $("input[name=class]:checked").val();
	$.ajax({
            type: 'POST',
            url: 'http://107.170.80.97:'+portNum+'/freqFinder/',
			async: false,
            data : {'idNum':idNumber, 'ambiguous':A, 'distance':d, 'ngWidth':ngWidth, 'numFreqs':fs, 'context':contextOnly},
            success: function(data){
				displayCounts(data);
